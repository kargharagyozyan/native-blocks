...
/***/ "./src/custom-blocks/rating-block/block.json":
/*!***************************************************!*\
  !*** ./src/custom-blocks/rating-block/block.json ***!
  \***************************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/rating-block","version":"0.1.0","title":"Rating Block","category":"widgets","icon":"smiley","description":"Example block scaffolded with Create Block tool.","example":{},"attributes":{"content":{"type":"string"}},"supports":{"html":false},"textdomain":"rating-block","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js"}');

/***/ }),

/***/ "./src/custom-blocks/rating-block/edit.js":
/*!************************************************!*\
  !*** ./src/custom-blocks/rating-block/edit.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/comment.js");
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/format-indent.js");
...
function Edit({
  ...
  const [loadingKey, setLoadingKey] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)(null);
  const AIPROVIDERS = [{
    title: 'Robot',
    content: "Lorem",
  ...
  const aiMenuControls = AIPROVIDERS.map(({
    title,
    content,
    icon
  }) => ({
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, {
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.DropdownMenu, {
          ...
          label: "AI Assistant",
          children: () => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.MenuGroup, {
            children: AIPROVIDERS.map(({
              title,
              content,
              icon
            }) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.MenuItem, {
              disabled: isLoading,
              onClick: () => {
                handleLoading(content, title);
              },
              children: [loadingKey === title && isLoading ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, {}) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Icon, {
                icon: icon
              }), title]
            }, title))
          })
...
/***/ "./src/custom-blocks/rating-block/index.js":
/*!*************************************************!*\
  !*** ./src/custom-blocks/rating-block/index.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/custom-blocks/rating-block/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/custom-blocks/rating-block/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/custom-blocks/rating-block/block.json");
...
/***/ "./src/custom-blocks/rating-block/style.scss":
/*!***************************************************!*\
  !*** ./src/custom-blocks/rating-block/style.scss ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"custom-blocks/rating-block/index": 0,
/******/ 			"custom-blocks/rating-block/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["custom-blocks/rating-block/style-index"], () => (__webpack_require__("./src/custom-blocks/rating-block/index.js")))
